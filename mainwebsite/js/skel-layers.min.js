...
skel.registerPlugin("layers", function(e) {
    ...
    return typeof e == gt ? H : (e.fn[p] = function() {
        ...
        if (!r[b] ||!(r[b]in this[xt]))
            r[b] = "top-left";
        r[en] || (r[en] = this[xt][r[b]][en]);
        if (!r[et] || typeof r[et] !== $t&&!(r[et]in this[ft]))
            r[et] = mt;
        r.clickToHide && i[Ot]("a")[S](Y, zt).on("click.skel-layers", function(r) {
            ...
            if (u.hasClass("skel-layers-ignore"))
                return;
            r[kt](), r[Et](), o[It]();
            if (u.hasClass("skel-layers-ignoreHref"))
                return;
            ...
            if (r[nt] && r.swipeToHide) {
                ...
                if (a)
                    return o[bt] = x, o[St] = x, o[It](), H
            }
            if (i[B]() == 0 && n < 0 || u > s - 2 && u < s + 2 && n > 0)
                return H
        }), this[s] = i
    }, cn[C][Z] = function() {
        return this[s] !== x
        ...
        init: function() {
            ...
            if (t[n][I]) {
                if (t._.vars[Mt] == "android" && t._.vars.deviceVersion < 4 || t._.vars[Mt] == "wp")
                    t[n][I] = H;
